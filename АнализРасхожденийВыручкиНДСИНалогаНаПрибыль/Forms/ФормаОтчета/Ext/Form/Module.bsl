...
Функция ИмяАнализРасхожденияНДСИНалогаНаПрибыль()

	Возврат "АнализРасхожденияНДСИНалогаНаПрибыль";

КонецФункции

&НаСервереБезКонтекста
Функция ИмяМассивСубконтоПДР()

	Возврат "МассивСубконтоПДР";

КонецФункции
&НаСервере
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	
	МассивСубконтоПДР = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
		ИмяАнализРасхожденияНДСИНалогаНаПрибыль(),
		ИмяМассивСубконтоПДР(),
		Новый Массив);
	Если МассивСубконтоПДР.Количество() = 0 Тогда
...
Процедура НастройкаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	СохранитьМассивСубконтоНаСервере();
...
&НаСервере
Процедура СохранитьМассивСубконтоНаСервере()
