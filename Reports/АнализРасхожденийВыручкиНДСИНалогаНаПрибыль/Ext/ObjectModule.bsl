...
Процедура ВставитьПоказатели_Прибыль(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Иначе
		...
		ТекстСообщения = НСтр("ru='Внимание! Расширение не адаптировано для работы с этой декларацией по налогу на прибыль - возможны ошибки.
			|Пожалуйста, обратитесь в за обновлением 1eska.ru'");
...
Процедура ВставитьПоказатели_НДС(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Иначе
		ТекстСообщения = НСтр("ru='Внимание! Расширение не адаптировано для работы с этой декларацией НДС - возможны ошибки.
			|Пожалуйста, обратитесь в за обновлением 1eska.ru'");
		ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
