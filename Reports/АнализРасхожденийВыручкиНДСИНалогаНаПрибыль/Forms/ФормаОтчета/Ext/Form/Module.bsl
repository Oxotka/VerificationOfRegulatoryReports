...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Информация = ИнформацияОРасширении();
...
Процедура Настройка(Команда)
	...
	ПараметрыФормы.Вставить("МассивСубконтоПДР", МассивСубконтоПДР);
...
&НаСервере
Функция ИнформацияОРасширении()

	Версия = Метаданные.Отчеты.АнализРасхожденийВыручкиНДСИНалогаНаПрибыль.РасширениеКонфигурации().Версия;
	ИнформацияОВерсии = Новый ФорматированнаяСтрока(СтрШаблон("Версия: %1", Версия));
	Сайт = Новый ФорматированнаяСтрока("1eska.ru",,,,"https://1eska.ru/");
...
Процедура СформироватьОтчетНаСервере()
	...
	РезультатФормированияОтчета = РеквизитФормыВЗначение("Отчет").СформироватьОтчет(ПараметрыОтчета);
	
	ПараметрыРасшифровки = РезультатФормированияОтчета.ПараметрыРасшифровки;
	Результат = РезультатФормированияОтчета.ТабличныйДокумент;
...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка, ДополнительныеПараметры)
	...
	ИначеЕсли ТипЗнч(Расшифровка) = Тип("Структура") И Расшифровка.Свойство("ИмяТаблицы") Тогда
		ИмяТаблицы = Расшифровка.ИмяТаблицы;
		Если ПараметрыРасшифровки.Свойство(ИмяТаблицы) Тогда 
			МассивРасшифровки = ПараметрыРасшифровки[ИмяТаблицы];
			ОткрытьФорму(
				"Отчет.АнализРасхожденийВыручкиНДСИНалогаНаПрибыль.Форма.ФормаРасшифровкиУчетныхДанных", 
				Новый Структура("МассивРасшифровки",
				МассивРасшифровки),
				ЭтотОбъект);
		КонецЕсли;
